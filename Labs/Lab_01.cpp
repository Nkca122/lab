...
int main(){
    ...
    readFile(worst_arr, "worst.txt");
    readFile(average_arr, "average.txt");
    readFile(best_arr, "best.txt");
    ...
    */
    ...
    cout << "\tdata_worst.txt: "<< bubble_worst << setprecision(15)<< endl << 
            "\tdata_average.txt: " << bubble_average << setprecision(15)<< endl << 
            "\tdata_best.txt: " << bubble_best << setprecision(15)<< endl;
    ...
    cout << "\tdata_worst.txt: "<< selection_worst << setprecision(15)<< endl << 
            "\tdata_average.txt: " << selection_average << setprecision(15)<< endl << 
            "\tdata_best.txt: " << selection_best << setprecision(15)<< endl;
    ...
    cout << "\tdata_worst.txt: "<< insertion_worst << setprecision(15)<< endl << 
            "\tdata_average.txt: " << insertion_average << setprecision(15)<< endl << 
            "\tdata_best.txt: " << insertion_best << setprecision(15)<< endl;
    ...
    cout << "\tdata_worst.txt: "<< merge_worst << setprecision(15) << endl << 
            "\tdata_average.txt: " << merge_average << setprecision(15) << endl <<
            "\tdata_best.txt: " << merge_best << setprecision(15) << endl;
    ...
    cout << "\tdata_worst.txt: "<< quick_worst << setprecision(15) << endl << 
            "\tdata_average.txt: " << quick_average << setprecision(15) << endl <<
            "\tdata_best.txt: " << quick_best << setprecision(15) << endl;
